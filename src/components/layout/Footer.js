			...
			<>
				<div className="item-logo-footer">
					...
					<div className="item-text">
						...
						<div>
							<span>
								Somos una empresa peruana que brinda servicios
								informáticos. Contamos con el mejor Sistema de Facturación
								Electrónica Verificado por SUNAT. Ofrecemos variedad de
								Planes, Capacitaciones, Soporte Online. Nuestros servicios
								están dirigidos a todas las empresas, sin importar su
								tamaño o rubro. ¡Fácil, rápida y confiable!
							</span>
						</div>
					</div>
				</div>
				...
				<div className="items-contacts">
					...
					<div className="item-contact">
						...
						>
							...
							<p>
								Ca. Nestor Bermudez 113, Esquina con Av. Fernando Terans
							</p>
						</div>
					</div>
				</div>
