    ...
    <Container>
      ...
      <div className="legend-plans">
        <p>
          ...
          Planes válidos para Lima Metropolitana, Callao, Arequipa Ciudad, Cusco
          Ciudad y Huancayo. Si te encuentras en otra ubicación puedes ver los
          Planes que tenemos para ti desde <a href="#">aquí</a>. (*) Ticketera
          incluida a modo de préstamo durante tu periodo de afiliación al Plan
          Control o superior.
        </p>
      </div>
    </Container>
